...
from features.engineering import create_medical_features, one_hot_encoding
from scaling import get_params_for_standardization, standardization
...
class DataPreprocessing:
    ...
    def fit_transform(self, X_train: pd.DataFrame, X_test: pd.DataFrame) -> Tuple[pd.DataFrame, pd.DataFrame]:
        ...
        columns_insert_medians = ['Glucose', 'BloodPressure', 'SkinThikness', 'Insulin', 'BMI']
        ...
        # capping(обрезание)
        columns_capping = ['Pregnancies', 'SkinThikness', 'Insulin']
        quantiles = [0.99] * 3
        ...
        columns_get_mean_std = ['Pregnancies', 'SkinThikness', 'Insulin', 'DiabetesPedigreeFunction', 'Age', 'HOMA_IR', 'BMI_AGE_BOND']
